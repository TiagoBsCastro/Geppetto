...
then immediately sums additive arrays and diagnostics for that segment on rank 0
before writing the final NPZ/FITS outputs and freeing the segment payload. With
